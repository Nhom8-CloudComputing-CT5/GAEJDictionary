package com.ponlongbong.GAEJDictionary;
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException { 
		 ...
		 try {
			...
			//Trim the stuff 
			 ...
			 if (strWord.length() == 0) 
				 throw new Exception("Word field cannot be empty.");
			 ...
			 DocumentBuilder builder = builderFactory.newDocumentBuilder(); Document doc = builder.parse(new InputSource(new StringReader(strCallResult.toString()))); 
